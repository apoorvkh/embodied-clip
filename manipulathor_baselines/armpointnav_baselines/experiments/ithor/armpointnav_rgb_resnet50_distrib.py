...
from manipulathor_baselines.armpointnav_baselines.experiments.ithor.armpointnav_rgb_resnet50 import ArmPointNavRGBResNet50

class ArmPointNavRGBResNet50Distrib(
    ArmPointNavRGBResNet50
):
    NUM_PROCESSES = 16
    def __init__(
        self,
